...
function peg$parse(input, options) {
  ...
  var peg$e9 = peg$classExpectation([["a", "z"], "_"], false, false);
  ...
  function peg$parseExpression() {
    ...
    s0 = [];
    s1 = peg$currPos;
    s2 = peg$parseOptionalClause();
    if (s2 === peg$FAILED) {
      s2 = peg$parseLogicalORClause();
      if (s2 === peg$FAILED) {
        s2 = peg$parseLITERAL();
        if (s2 === peg$FAILED) {
          s2 = peg$parseIDENT();
  ...
  function peg$parseOptionalClause() {
  ...
  function peg$parseLogicalORClause() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;
  ...
  function peg$parseWHITESPACE_OR_NEWLINE() {
    var s0;
